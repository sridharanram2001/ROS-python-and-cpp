...
(cl:in-package My_programs_package-msg)
...
(cl:defmethod cl:initialize-instance :after ((m <IOT_sensor>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'IOT_sensor)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name My_programs_package-msg:<IOT_sensor> is deprecated: use My_programs_package-msg:IOT_sensor instead.")))

(cl:ensure-generic-function 'id-val :lambda-list '(m))
(cl:defmethod id-val ((m <IOT_sensor>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader My_programs_package-msg:id-val is deprecated.  Use My_programs_package-msg:id instead.")
  (id m))

(cl:ensure-generic-function 'name-val :lambda-list '(m))
(cl:defmethod name-val ((m <IOT_sensor>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader My_programs_package-msg:name-val is deprecated.  Use My_programs_package-msg:name instead.")
  (name m))

(cl:ensure-generic-function 'temperature-val :lambda-list '(m))
(cl:defmethod temperature-val ((m <IOT_sensor>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader My_programs_package-msg:temperature-val is deprecated.  Use My_programs_package-msg:temperature instead.")
  (temperature m))

(cl:ensure-generic-function 'humidity-val :lambda-list '(m))
(cl:defmethod humidity-val ((m <IOT_sensor>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader My_programs_package-msg:humidity-val is deprecated.  Use My_programs_package-msg:humidity instead.")
  (humidity m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<IOT_sensor>)))
  ...
  "My_programs_package/IOT_sensor")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'IOT_sensor)))
  "Returns string type for a message object of type 'IOT_sensor"
  "My_programs_package/IOT_sensor")
