...
double degrees2radians(double angle_in_deg)
{
...
double setDesiredOrientation(double desired_angle_rad)
{

   double relative_angle_rad = desired_angle_rad - turtlesim_pose.theta;

   bool clockwise = ((relative_angle_rad<0)?true:false);



   rotate(degrees2radians(30),abs(relative_angle_rad),clockwise);
